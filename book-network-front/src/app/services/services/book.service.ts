...
import { saveBookCover } from '../fn/book/save-book-cover';
import { SaveBookCover$Params } from '../fn/book/save-book-cover';
...
import { updateBookSharebleStatus } from '../fn/book/update-book-shareble-status';
import { UpdateBookSharebleStatus$Params } from '../fn/book/update-book-shareble-status';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `saveBookCover()` */
  static readonly SaveBookCoverPath = '/books/cover/{bookId}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `saveBookCover()` instead.
   *
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  saveBookCover$Response(params: SaveBookCover$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return saveBookCover(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `saveBookCover$Response()` instead.
   *
   * This method sends `multipart/form-data` and handles request body of type `multipart/form-data`.
   */
  saveBookCover(params: SaveBookCover$Params, context?: HttpContext): Observable<number> {
    return this.saveBookCover$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
  ...
  /** Path part for operation `updateBookSharebleStatus()` */
  static readonly UpdateBookSharebleStatusPath = '/books/shareble/{bookId}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `updateBookSharebleStatus()` instead.
   *
   * This method doesn't expect any request body.
   */
  updateBookSharebleStatus$Response(params: UpdateBookSharebleStatus$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return updateBookSharebleStatus(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `updateBookSharebleStatus$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  updateBookSharebleStatus(params: UpdateBookSharebleStatus$Params, context?: HttpContext): Observable<number> {
    return this.updateBookSharebleStatus$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
  ...
  static readonly UpdateBookArchiveStatusPath = '/books/archived/{bookId}';
